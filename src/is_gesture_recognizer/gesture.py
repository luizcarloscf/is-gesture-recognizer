...
class GestureRecognizer(nn.Module):
    def __init__(self, model_path, dropout=0.1, logstd1=-1, logstd2=-2, pi=0.5):
        ...
        self.bfc1 = bl.Linear(self.input_size, 128, **linear_args)
        self.bfc2 = bl.Linear(128, self.embeding_size, **linear_args)
    ...
    def predict(self, skeleton):
        ...
        spp_pred, spp_prob, spp_unc, spp_std = self.spotting.predict(skeleton, mc_samples)
        ...
        if not self.movement:
            ...
            return 0, spp_prob, spp_unc, spp_std
...
if __name__ == "__main__":
    import time
    args = sys.argv
    model_path = "model_gesture4_0_93.95.pth" if len(args) == 1 else args[1]
