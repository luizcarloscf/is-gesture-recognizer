...
_GESTUREINFO = _descriptor.Descriptor(
  name='GestureInfo',
  full_name='GestureInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='prediction', full_name='GestureInfo.prediction', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='probability', full_name='GestureInfo.probability', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='uncertainty', full_name='GestureInfo.uncertainty', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='created_at', full_name='GestureInfo.created_at', index=3,
      number=4, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['GestureInfo'] = _GESTUREINFO
...
GestureInfo = _reflection.GeneratedProtocolMessageType('GestureInfo', (_message.Message,), dict(
  DESCRIPTOR = _GESTUREINFO,
  __module__ = 'options_pb2'
  # @@protoc_insertion_point(class_scope:GestureInfo)
  ))
_sym_db.RegisterMessage(GestureInfo)
